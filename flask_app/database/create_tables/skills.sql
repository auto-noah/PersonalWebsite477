...
`experience_id`      int(11)       NOT NULL 				COMMENT 'FK:References the experiences.experience_id',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT="Skills I have learned during my experiences";